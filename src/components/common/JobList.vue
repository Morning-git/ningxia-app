<template>
  <div class="flex flex-col gap-3">
    ...
    >
      <div class="cursor-pointer" @click="handleClick(job)">
    ...
    <div v-else-if="hasMore && jobs.length > 0" class="text-center py-4">
      <span class="text-gray-400 text-sm" @click="loadMore">上拉加载更多</span>
    </div>
    <div v-else-if="jobs.length === 0" class="text-center py-10">
      <p class="text-gray-400">暂无职位信息</p>
    </div>
  </div>
</template>
